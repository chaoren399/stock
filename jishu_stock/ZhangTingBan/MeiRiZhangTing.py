...
chengongs=[]
modelname='MeiRiZhangTing'

def get_all_MeiRiZhangTing(localpath1):
    info1=  '--MeiRiZhangTing-start-- '
    ...
    for index, row in data.iterrows():
        ...
        len1 = len(data6_1)
        isAn_MeiRiZhangTing_model(data6_1, stock_code)


'''
#2 单独一个函数 判断 6 个数据是不是符合模型
'''
def isAn_MeiRiZhangTing_model(data, stockcode):
    ...
    if(len_data >= 2):
        ...
        data1= data[len_data-7:len_data]
...
def test_isAn_JGZS_KanZhangZuoZhang_ziji():
    ...
    isAn_MeiRiZhangTing_model(data7_1, '000812.SZ')
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 - 2 + 1):
            ...
            isAn_MeiRiZhangTing_model(data7_4[i:i + 2], stock_code)
...
if __name__ == '__main__':
    ...
    get_all_MeiRiZhangTing(localpath1)
