...
from jishu_stock.Tool_jishu_stock import writeLog_to_txt, writeLog_to_txt_nocode, isYinXian
    ...
    if(len(data)==3):
        ...
        for index, row in data.iterrows():
            ...
            if(index == 1): #第 2 天是个大阴线
                if(isYinXian(row)==1 and getShiTiDaXiao(row) > 3.5):
                    day2_isYinxian=1
            ...
            if(index==2): #第 3 天 阳线,收盘价高过阴线开盘价
                ...
                # print 'day2_open = ' +str(day2_open)
                # print 'day2_isYinxian=' + str(day2_isYinxian)
                if(day3_open < day3_close and  day2_isYinxian==1 and  day3_close > day2_open):
                    isday3yangxian =1
                    # print 'isday3yangxian =1'

            if(isZhangtingban ==1 and day2_isYinxian==1 and  isday3yangxian ==1):
