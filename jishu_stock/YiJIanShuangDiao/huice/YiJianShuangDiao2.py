...
2021年12月18日 增加  4 条 K 线 的收盘价 在 5 日线以上的条件
...
def get_all_YiJianShuangDiao2(localpath1):

    info1=  '--一箭双雕2 主力中继洗盘模型 start--   '
    ...
    for index, row in data.iterrows():
        ...
        len1 = len(data6_1)
        isAn_YiJianShuangDiao2_model(data6_1, stock_code)
...
'''
def isAn_YiJianShuangDiao2_model(data,stockcode):
    ...
    if(len_data >=14):
        ...
        if(key_1==1 and  key_2 ==1  and key_3==1 and key_5==1  and key_7==1  and key_8==1):
            info=''
            ...
            # if (1):
                ...
                info = info+"-----一箭双雕2 主力中继洗盘模型 ---- "  + str(mairuriqi)
                # print info
...
测试老师的案例
'''
def test_isAn_YiJianShuangDiao2_laoshi():
    ...
    data7_1 = df1.iloc[0:14]  # 前4行
    # print data7_1
    isAn_YiJianShuangDiao2_model(data7_1,'002229.SZ')


'''
测试老师举例讲解学生 失败案例
'''
def test_isAn_YiJianShuangDiao2_laoshi_shibai_anli():
    # 案例 1

    df1 = ts.pro_bar(ts_code='600900.SH',adj='qfq', start_date='20210206', end_date='20210927',ma=[5, 13, 34])
    data7_1 = df1.iloc[0:14]  # 前4行
    # print data7_1
    isAn_YiJianShuangDiao2_model(data7_1,'600900.SH')

def linshi():
    df1 = ts.pro_bar(ts_code='002125.SZ',adj='qfq', start_date='20200206', end_date='20211025',ma=[5, 13, 34,10,20])
    data7_1 = df1.iloc[0:14]  # 前4行
    # print data7_1
    isAn_YiJianShuangDiao2_model(data7_1,'002125.SZ')
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 - 14 + 1):
            ...
            isAn_YiJianShuangDiao2_model(data7_4[i:i + 14], stock_code)
...
if __name__ == '__main__':
    ...
    # get_all_YiJianShuangDiao2(localpath1)
    # test_isAn_YiJianShuangDiao2_laoshi()#测试老师举例 5个成功案例 其中一个 阴线实体为0, 总共 4 个成功
    # test_isAn_YiJianShuangDiao2_laoshi_shibai_anli()#测试老师举例讲解学生 失败案例 符合程序的为 0,说明程序非常不错
