...
def get_all_ShenLongBaiWei4_1(localpath1):
    ...
    for index, row in data.iterrows():
        ...
        if (1):
            ...
            if (df.empty):
                ...
                # iloc只能用数字索引，不能用索引名
            n=14
            data7_1 = df.iloc[n+0:n+20]  #  回测

            len_data7_1=len(data7_1)
            # riqi_0 = data7_1.ix[len_data7_1-1]['trade_date']
            riqi_0 = data7_1.ix[n]['trade_date']
            # print riqi_0
            huice_riqi = str(riqi_0)
            # print1(huice_riqi)
    ...
    print get_DaPan_HuanJing(huice_riqi)
