...
def isAn_JGZS_KanZhangYinXian4_model(data,stockcode):
    ...
    if(len_data >=2):
        ...
        key_7=0; #  7 阳线的收盘价 必须小于阴线的开盘价
        key_8=0; # 8 下影线 长度大于 0.1
        ...
        if(count==2): #满足一阳一阴 才继续
            ...
            # 7 阳线的收盘价 必须小于阴线的开盘价  20220403.0上影线最好为0-,出版业,凤凰传媒**601928.SH
            if(week2_close < week1_open):
                key_7=1

            week1_xiayingxian1 = round(week1_xiayingxian, 3)
            if(week1_xiayingxian1 >0.1): #下影线 长度大于 0.1
                key_8=1
        ...
        if(key_1==1 and  key_2 ==1 and key_3==1 and key_4==1 and key_5==1 and key_6==1 and key_7==1 and key_8==1):
        # if(key_1==1 and  key_2 ==1 and key_3==1 and key_4==1 and key_5==1 and key_6==1 and key_7==1 ):
            ...
            info=info+'--下影线='+str(week1_xiayingxian1)
