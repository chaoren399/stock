...
def isAn_ChouMaTuPo_model(data,stockcode):
    ...
    if(len_data >= 6):
        ...
        key_2=1; # 这个阳线收盘价 创最近 20 天的 新高.
        key_6=0; # 判断是不是 小于 100 亿
        ...
        for index, row in data2.iterrows():
            day_close= row['close']
            if(day_close > day1_close):  # 前边有比 6%K 线高的
                key_2=0
        ...
        if(key_1==1 and  key_2 ==1):
            ...
            if(key_6==1):
                ...
                info = info + "--筹码突破 看周线 然后看日线--"  + str(riqi)
                # print info
...
def test_isAn_ChouMaTuPo_laoshi():
    # 案例 1  案例: 吴通控股 -20190416-300292.SZ
