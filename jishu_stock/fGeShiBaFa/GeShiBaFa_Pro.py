...
from jishu_stock.Tool_jishu_stock import writeLog_to_txt, isInQiangShi_gupiaochi, get_Stock_Name, \
    writeLog_to_txt_nocode, is_big_to_small, print1
...
def isAn_GEShi8_model(data,data1,stock_code):
    ...
    if(len_data>3):
        ...
        if(key_1==1 and key_2==1 and key_3==1and key_4==1):
                ...
                # path = BASE_DIR + '/jishu_stock/JieGuo/G8/9/' +'G8M1-'+ datetime.now().strftime('%Y-%m-%d') +'.txt'
