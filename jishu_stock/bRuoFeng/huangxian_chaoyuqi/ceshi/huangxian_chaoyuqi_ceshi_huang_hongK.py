...
from jishu_stock.z_tool.isZhangTingBan import isZhangTingBan, isHuangXian, isZhangTingBan_zzy
...
'''
chengongs=[]
modelname='huangxian_chaoyuqi'
cn_name='黄线超预期'
#BASE_DIR + '/jishu_stock/z_stockdata/模型编码.csv'


def get_all_huangxian_chaoyuqi(localpath1):
    info1 = '--黄线超预期 start--'
...
'''
def isAn_huangxian_chaoyuqi_model(data,stockcode):
    ...
    if(len_data >= 3):
        ...
        data1= data[len_data-4:len_data]   #  要计算 振幅 需要 前一天数据， 所以需要4个
        ...
        len_data1=len(data1)
        print str(len_data1) + "=len_data1"
        last_day_data1=data1.loc[2:3]
        last_day_data1=data1.loc[len_data1-2:len_data1-1]

        print isZhangTingBan_zzy(last_day_data1)
        print '涨停为1,跌停为2,炸板为3-------------------'
        print last_day_data1
        ...
        #         print data1.loc[0:3]
        #
        #     if(index==1 and isHuangXian(row,day0_close)==1):
        #         key_1=1
...
测试老师的案例 -测试 黄线-基本是炸板 
'''
def test_isAn_huangxian_chaoyuqi_model_laoshi_HuangK():
    # 案例 1 海立股份**600619.Sh
    st_code='600619.Sh'
    ...
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241029')
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241018')
...
测试老师的案例 -测试  红线-涨停板
'''
def test_isAn_huangxian_chaoyuqi_model_laoshi_HongK():
    # 案例 1 海立股份**600619.Sh
    st_code='600619.Sh'
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241109')
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241108')
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241106')
    df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241021')
    ...
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241108')
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241106')
    # df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241105')
    df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20241030')
...
测试老师的案例 -测试  蓝K-跌停板
'''
def test_isAn_huangxian_chaoyuqi_model_laoshi_LanK():
    # 案例 1 海立股份**600619.Sh
    st_code='600619.Sh'
