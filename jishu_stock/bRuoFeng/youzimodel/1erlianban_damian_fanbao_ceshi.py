...
'''
chengongs=[]
modelname='lianban_damian_fanbao'
#BASE_DIR + '/jishu_stock/z_stockdata/模型编码.csv'



def get_all_lianban_damian_fanbao(localpath1):
    info1=  '--二连板大面反包  start--   '
...
'''
def isAn_lianban_damian_fanbao_model(data,stockcode):
    ...
    if(len_data >= 3):
        ...
        if(key_1==1 & key_2==1 and key_3==1 and key_4==1):
        # if(key_1==1 ):
            info = ''

            info = info + "lianban_damian_fanbao--"  + str(mairuriqi)
            # print len(data)
            # print info
...
测试老师的案例
'''
def test_isAn_lianban_damian_fanbao_model_laoshi():
    # 案例 1 jinlongyu
    st_code='002882.SZ'
    df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20240110')
    ...
    # 案例 2 jian qiao keji
    st_code='603083.SH'
    df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20240123')
    ...
    # 案例 3 金龙汽车**600686.SH
    st_code='600686.SH'
    df1 = ts.pro_bar(ts_code=st_code,adj='qfq', start_date='20210206', end_date='20240725')
    data7_1 = df1.iloc[0:30]  # 前7行
    # print data7_1
    isAn_lianban_damian_fanbao_model(data7_1,st_code)
