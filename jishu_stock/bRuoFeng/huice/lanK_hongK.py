...
from jishu_stock.z_tool.isZhangTingBan import isZhangTingBan, isZhangTingBan_pro, isDieTingBan_pro
...
'''
chengongs=[]
modelname='lanK_hongK'
#BASE_DIR + '/jishu_stock/z_stockdata/模型编码.csv'


def get_all_lanK_hongK(localpath1):
    info1 = '--lanK_hongK  start--'
    ...
    for index, row in data.iterrows():
        ...
        len1 = len(data6_1)
        isAn_lanK_hongK_model(data6_1, stock_code)


'''
#2 单独一个函数 判断 6 个数据是不是符合模型
'''
def isAn_lanK_hongK_model(data,stockcode):
    ...
    if(len_data >= 2):
        ...
        for index,row in data1.iterrows():
            ...
            if(index==0 and isDieTingBan_pro(row)==1):
                key_1=1
            if(index==1 and isZhangTingBan_pro(row)==1):
                key_2=1
        ...
        # if(key_1==1 ):
            ...
            info = info + "lanK_hongK--"  + str(mairuriqi)
            # print len(data)
            # print info
...
测试老师的案例
'''
def test_isAn_lanK_hongK_model_laoshi():
    # 案例 1 捷荣技术**002855.SZ
    st_code='300374.SZ'
    ...
    # print data7_1
    isAn_lanK_hongK_model(data7_1,st_code)
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 ):
            ...
            isAn_lanK_hongK_model(data7_4[i:i + 2], stock_code)
            # print data7_4[i:i + 2]
...
if __name__ == '__main__':
    ...
    # test_isAn_lanK_hongK_model_laoshi()
    # get_all_lanK_hongK(localpath1)
    test_Befor_data()
