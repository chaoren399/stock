...
def get_all_HuanShou2(localpath1):
    info1=  '--换手2start--   '
    ...
    for index, row in data.iterrows():
        ...
        len1 = len(data6_1)
        isAn_HuanShou2_model(data6_1, stock_code)
...
'''
def isAn_HuanShou2_model(data,stockcode):
...
def test_isAn_HuanShou1_laoshi():
    ...
    isAn_HuanShou2_model(data7_1,'002432.SZ')
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 -n + 1):
            ...
            isAn_HuanShou2_model(data7_4[i:i + 5], stock_code)
