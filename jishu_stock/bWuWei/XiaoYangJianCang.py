...
''''
小阳建仓
思路： 找到连续5天阳线 的股票， 并且， 开盘价都比前一天高 ， 这种持续观察
...
def get_all_XiaoYangJianCang(localpath1):
    info1 = '--小阳建仓1 start--   '
...
def isAn_XiaoYangJianCang_model(data, stockcode):
    ...
    if (len_data >= 10):
        ...
        if(count==5):
            key_1=1
        if(day5_low > day4_low and day4_low > day3_low and day2_low> day1_low):
            key_2=1
        ...
        if (key_1 == 1 and key_2==1):
            ...
            info = info + "--小阳建仓1 成功了--" + '--日期:' + str(riqi)
            # print info
...
def test_isAn_XiaoYangJianCang_ziji():
    ...
    isAn_XiaoYangJianCang_model(data7_1, '002507.SZ')
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 - n + 1):
            ...
            isAn_XiaoYangJianCang_model(data7_4[i:i + n], stock_code)
...
if __name__ == '__main__':
    ...
    get_all_XiaoYangJianCang(localpath1)
    # test_isAn_XiaoYangJianCang_laoshi()
    # test_Befor_data()
