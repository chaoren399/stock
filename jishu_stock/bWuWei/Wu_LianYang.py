...
def get_all_5LianYang(localpath1):
    info1 = '--5连阳,开盘价依次提高 start--   '
...
def isAn_5LianYang_model(data, stockcode):
    ...
    if (len_data >= 10):
        ...
        if(count==5):
            if(day1_open < day2_open  and day2_open < day3_open and day3_open < day4_open and day4_open< day5_open ):
        ...
        if (key_1 == 1 ):
            ...
            info = info + "--5连阳,开盘价依次提高--" + '--日期:' + str(riqi)
            # print info
...
def test_isAn_XiaoYangJianCang_ziji():
    ...
    isAn_5LianYang_model(data7_1, '002507.SZ')
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 - n + 1):
            ...
            isAn_5LianYang_model(data7_4[i:i + n], stock_code)
...
if __name__ == '__main__':
    ...
    get_all_5LianYang(localpath1)
    # test_isAn_5LianYang_laoshi()
    # test_Befor_data()
