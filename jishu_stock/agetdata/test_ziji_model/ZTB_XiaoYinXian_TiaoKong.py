...
def get_all_ZTB_YinXian_TiaoKong(localpath1):
    info1=  '--昨天涨停板, 今天跳空高开的小阴线,60 周向上  start--   '
...
def test_isAn_ZTB_YinXian_TiaoKong_laoshi():
    ...
    # 案例 1
    df1 = ts.pro_bar(ts_code='000030.SZ',adj='qfq', start_date='20210206', end_date='20211115')
    data7_1 = df1.iloc[0:30]  # 前7行
    isAn_ZTB_YinXian_TiaoKong_model(data7_1,'000030.SZ')
    # 案例 2 000400
    df1 = ts.pro_bar(ts_code='000400.SZ',adj='qfq', start_date='20210206', end_date='20211115')
    data7_1 = df1.iloc[0:30]  # 前7行
    isAn_ZTB_YinXian_TiaoKong_model(data7_1,'000400.SZ')
    # 案例 3
    df1 = ts.pro_bar(ts_code='000998.SZ',adj='qfq', start_date='20210206', end_date='20211110')
    data7_1 = df1.iloc[0:30]  # 前7行
    isAn_ZTB_YinXian_TiaoKong_model(data7_1,'000998.SZ')
    # 案例 4
    df1 = ts.pro_bar(ts_code='002006.SZ',adj='qfq', start_date='20210206', end_date='20211116')
    data7_1 = df1.iloc[0:30]  # 前7行
    isAn_ZTB_YinXian_TiaoKong_model(data7_1,'002006.SZ')

    # 案例 6    '002017.SZ:20211110',
    df1 = ts.pro_bar(ts_code='002017.SZ',adj='qfq', start_date='20210206', end_date='20211110')
    data7_1 = df1.iloc[0:30]  # 前7行
...
def test_isAn_ZTB_YinXian_TiaoKong_ziji():
    ...
    df1 = ts.pro_bar(ts_code='600499.SH',adj='qfq', start_date='20210206', end_date='20211111')
    data7_1 = df1.iloc[0:30]  # 前7行
    isAn_ZTB_YinXian_TiaoKong_model(data7_1,'600499.SH')
