...
式复盘- 第一天涨停，第2天没有涨停，相对第1天放量， 第3天没涨涨停(阳线)，相对第1天放量，第4天涨停(高开)
...
def get_all_ZTB_FL_FL_ZTBB(localpath1):
    info1=  '-- start-- 涨停板后 涨停后放量2天  '
    ...
    for index, row in data.iterrows():
        ...
        len1 = len(data6_1)
        isAn_ZTB_FL_FL_ZTBB_model(data6_1, stock_code)
...
'''
def isAn_ZTB_FL_FL_ZTBB_model(data,stockcode):
    ...
    if(len_data >= 3):
        ...
        if(day1_amount < day2_amount):
            key_2=1
        if(day1_amount < day3_amount):
            key_3=1
        ...
        # if(key_1==1 and key_2==1):
            ...
            info = info + "--涨停后放量2天 成功了"  + str(riqi)
            # print info
...
def test_isAn_ZTB_ZTB_TiaoKong_laoshi():
    # 案例 1 瀚新材 -301076
    df1 = ts.pro_bar(ts_code='301076.SZ',adj='qfq', start_date='20250424', end_date='20250808')
    data7_1 = df1.iloc[0:30]  # 前7行
    # print data7_1
    isAn_ZTB_FL_FL_ZTBB_model(data7_1,'002174.SZ')
...
def test_isAn_ZTB_ZTB_TiaoKong_ziji():
    ...
    isAn_ZTB_FL_FL_ZTBB_model(data7_1,'002507.SZ')
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 - n + 1):
            ...
            isAn_ZTB_FL_FL_ZTBB_model(data7_4[i:i + n], stock_code)
...
if __name__ == '__main__':
    ...
    # get_all_ZTB_FL_FL_ZTBB(localpath1)
    # test_Befor_data()
    test_isAn_ZTB_ZTB_TiaoKong_laoshi()
