...
''''
有惊无险2-2  第一天大阴线, 第 2 天如果是阳线 收盘价 不能超过 阴线的开盘价 (最低价呢?),  第 3 天 阳线收 盘价 超过阴线开盘价
...
def get_all_YouJingWuXian2_2(localpath1):
    info1=  '--有惊无险2_2start--   '
...
'''
def isAn_YouJingWuXian2_2_model(data,stockcode):
    ...
    if(len_data >= 65):
        ...
        key_5=1 # 第 第 2 天 开盘价 收盘价 不能超过 阴线的开盘价
        ...
        for index,row in data1.iterrows():
            ...
            if(index==3 and isYangXian(row)==1): #阳线收盘价
        ...
        if(count==2): #符合 阴阳
            ...
            if(day1_yinxian_shiti>1.6):
                key_2=1
            if(day3_yangxian_close > day1_yinxian_open):
                key_3=1
            if(day2_close > day1_yinxian_open or day2_open > day1_yinxian_open):
                key_5=0
...
测试老师的案例
'''
def test_isAn_YouJingWuXian2_2_laoshi():
    ...
    # print data7_1
    isAn_YouJingWuXian2_2_model(data7_1,'300114.SZ')
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 - n + 1):
            ...
            isAn_YouJingWuXian2_2_model(data7_4[i:i + n], stock_code)
...
if __name__ == '__main__':
    ...
    # get_all_YouJingWuXian2_2(localpath1)
    # test_isAn_YouJingWuXian2_2_laoshi()
    test_Befor_data()