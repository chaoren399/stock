...
''''
有惊无险2-1  第一天大阴线, 第 2 天 阳线收 盘价 超过阴线开盘价
...
def isAn_YouJingWuXian2_1_model(data,stockcode):
    ...
    if(len_data >= 65):
        ...
        data2= data[len_data-3-60:len_data-3]
        ...
        for index,row in data1.iterrows():
            ...
            if(index==2 and isYangXian(row)==1): #阳线收盘价
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        for i in range(0, len_1 - n + 1):
            ...
            isAn_YouJingWuXian2_1_model(data7_4[i:i + n], stock_code)
