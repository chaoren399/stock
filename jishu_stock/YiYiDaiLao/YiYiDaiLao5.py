...
''''
以逸待劳5 主力洗盘模型 第 10天 阳线收盘价高过第 5 天收盘价
...
def get_all_YiYiDaiLao(localpath1):
    info1=  '--以逸待劳5 完美符合模型, 第 10 天阳线收盘主力洗盘模型 start--   '
...
def YiYiDaiLao5(data1_1,data2,stockcode):
    ...
    if (key_1 == 1 and key_2 == 1 and key_3 == 1  and key_4 == 1and key_5 == 1):
        ...
        info = info + "-----以逸待劳5-10天数据,主力洗盘 短期爆发 筑底后 缓慢上涨----" + str(riqi)
        # print info
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        data7_4 = df.iloc[22:22 + 26 + 5]  # 前 1 个月
