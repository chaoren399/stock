...
''''
以逸待劳1 主力洗盘模型  第 6 天 阳线收盘价高过第 5 天收盘价
...
def get_all_YiYiDaiLao(localpath1):
    info1=  '--以逸待劳1 完美符合模型, 第 6 天阳线收盘主力洗盘模型 start--   '
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        data7_4 = df.iloc[22:22+26 +3]  # 前10个交易日
        # data7_4 = df.iloc[22:22+26 +10]  # 前10个交易日
        # data7_4 = df.iloc[22:22+26 +250]  # 前10个交易日
        len_1=len(data7_4)
