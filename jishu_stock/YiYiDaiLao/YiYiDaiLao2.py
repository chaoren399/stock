...
''''
以逸待劳2 主力洗盘模型  第 7 天 阳线收盘价高过第 5 天收盘价
...
第 7 天 阳线收盘价高过第 5 天收盘价
6,7 ,8,9,10
'''
chengongs=[]
modelname='以逸待劳2'
def get_all_YiYiDaiLao(localpath1):
    info1=  '--以逸待劳2 完美符合模型, 第 67天阳线收盘主力洗盘模型 start--   '
...
def test_Befor_data():
    ...
    for index, row in data.iterrows():
        ...
        # data7_4 = df.iloc[22:22+26+22]  # 1个月
        data7_4 = df.iloc[22:22+26+120]  # 半年
        # data7_4 = df.iloc[22:22+26+250]  # 1年
    ...
    jisuan_all_shouyilv(chengongs1, modelname, 1.05)
    jisuan_all_shouyilv(chengongs1, modelname, 1.07)
    jisuan_all_shouyilv(chengongs1, modelname, 1.10)
    jisuan_all_shouyilv(chengongs1, modelname, 1.15)
    jisuan_all_shouyilv(chengongs1, modelname, 1.20)
    jisuan_all_shouyilv(chengongs1, modelname, 1.30)
