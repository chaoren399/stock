...
''''
以逸待劳3 主力洗盘模型  盯盘的 5 天数据, 第 6 天收阳线 尾盘买入
...
'''
测试 8天数据,  第6,7 天 收盘价 都低于第 5 天收盘价,  
第 8 天 阳线收盘价高过第 5 天收盘价, 
'''
def YiYiDaiLao3(data1_1,data2,stockcode):
    ...
    if(day6_close <= day5_close and day7_close <= day5_close and  day8_close > day5_close and  day8_is_yangxian==1):
        key_4=1
